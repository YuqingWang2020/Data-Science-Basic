...
'''
    ...
    ......
    # YOUR CODE HERE
    avg_gold=numpy.mean(gold)
    avg_silver=numpy.mean(silver)
    avg_bronze=numpy.mean(bronze)
    avg_medal_count = pandas.Series([avg_gold, avg_silver, avg_bronze],index=['gold', 'silver',
                              'bronze'])
'''